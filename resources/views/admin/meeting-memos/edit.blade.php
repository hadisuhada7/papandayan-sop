...
@section('title', 'Papandayan | Edit Meeting Memo')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Meeting Memo</h3>
                </div>
                <form id="meeting-memo-form" method="POST" action="{{ route('admin.meeting-memos.update', $meetingMemo) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control select2bs4" style="width: 100%;" id="company" name="company_id" required>
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}" {{ $company->id == $meetingMemo->company_id ? 'selected' : '' }}>{{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        @php
                                            $selectedCategoryIds = (array) old('category_ids', $meetingMemo->categories->pluck('id')->toArray());
                                        @endphp
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $meetingMemo->title }}" maxlength="255" placeholder="Title" required>
                                        <span class="error invalid-feedback">{{ $errors->first('title') }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="documentNumber" class="col-sm-2 col-form-label">Document Number</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="documentNumber" name="document_number" value="{{ $meetingMemo->document_number }}" maxlength="100" placeholder="Document Number">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date" id="effectiveDate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="effective_date" value="{{ $meetingMemo->effective_date ? $meetingMemo->effective_date->format('d-m-Y') : '' }}" data-target="#effectiveDate" placeholder="dd-MM-yyyy" required/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date" id="expiredDate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" id="expiredDateInput" name="expired_date" value="{{ old('expired_date', $meetingMemo->expired_date ? $meetingMemo->expired_date->format('d-m-Y') : '') }}" data-target="#expiredDate" placeholder="dd-MM-yyyy" {{ $meetingMemo->expired_date === null && !old('expired_date') ? '' : 'required' }}/>
                                    ...
                                    <div class="col-sm-3 d-flex align-items-center">
                                        <div class="icheck-primary">
                                            <input type="checkbox" id="noExpiredDate" name="no_expired_date" value="1" {{ old('no_expired_date', $meetingMemo->expired_date === null ? '1' : '') ? 'checked' : '' }}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="rules" name="rules" maxlength="65535" placeholder="Rules">{{ $meetingMemo->rules }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <table id="datagrid" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($meetingMemo->documents as $index => $document)
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.meeting-memos.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
...
@section('adminlte_js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            const initialCategories = {!! json_encode($meetingMemo->categories->pluck('id')->toArray()) !!};
            const initialCompanyId = '{{ $meetingMemo->company_id }}';
            ...
            $('#meeting-memo-form').on('submit', function (e) {
                e.preventDefault();
                ...
                existingDocumentIds.forEach(function(id) {
                    ...
                    existingInput.name = 'existing_document_ids[]';
                    existingInput.value = id;
                    existingInput.className = 'js-generated-document-input';
