...
@section('title', 'Papandayan | Internal Memos')
...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Internal Memos</h1> 
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Internal Memos</li>
            </ol>
        </div>
    </div>
@stop
                            ...
                            @foreach($internalMemos as $internalMemo)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.internal-memos.show', $internalMemo) }}" class="btn btn-sm btn-info item-detail"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('admin.internal-memos.edit', $internalMemo) }}" class="btn btn-sm btn-primary item-edit"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger item-remove" data-id="{{ $internalMemo->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @php 
                                    $index++; 
        ...
        $(document).ready(function () {
            ...
            $("#datagrid").DataTable({
                ...
                initComplete: function(settings, json) {
                    ...
                    $('<a href="{{ route('admin.internal-memos.create') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">Add New</a>')
            ...
            $("#btn-modal-delete").on("click", function(){
                if (selectedRow) {
                    var deleteUrl = "{{ route('admin.internal-memos.index') }}/" + selectedRow;
