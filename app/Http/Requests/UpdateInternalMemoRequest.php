...
class UpdateInternalMemoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'no_expired_date' => ['nullable', 'boolean'],
            'expired_date' => ['required_without:no_expired_date', 'nullable', 'date', 'after_or_equal:effective_date'],
