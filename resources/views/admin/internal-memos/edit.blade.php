...
@section('title', 'Papandayan | Edit Internal Memo')
        ...
        <div class="col-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Internal Memo</h3>
                </div>
                <form id="internal-memo-form" method="POST" action="{{ route('admin.internal-memos.update', $internalMemo) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control select2bs4" style="width: 100%;" id="company" name="company_id" required>
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}" {{ $company->id == $internalMemo->company_id ? 'selected' : '' }}>{{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        @php
                                            $selectedCategoryIds = (array) old('category_ids', $internalMemo->categories->pluck('id')->toArray());
                                        @endphp
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $internalMemo->title }}" maxlength="255" placeholder="Title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="documentNumber" name="document_number" value="{{ $internalMemo->document_number }}" maxlength="100" placeholder="Document Number" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date" id="effectiveDate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="effective_date" value="{{ $internalMemo->effective_date ? $internalMemo->effective_date->format('d-m-Y') : '' }}" data-target="#effectiveDate" placeholder="dd-MM-yyyy" required/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="rules" name="rules" maxlength="65535" placeholder="Rules">{{ $internalMemo->rules }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <table id="datagrid" class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    @forelse($internalMemo->documents as $index => $document)
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('admin.internal-memos.index') }}" class="btn btn-default" style="margin-right: 5px">Back</a>
...
@section('adminlte_js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            const initialCategories = {!! json_encode($internalMemo->categories->pluck('id')->toArray()) !!};
            const initialCompanyId = '{{ $internalMemo->company_id }}';
            ...
            $('#internal-memo-form').on('submit', function (e) {
                e.preventDefault();
