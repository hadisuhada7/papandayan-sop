...
@section('title', 'Papandayan | Add Internal Memo')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form id="internal-memo-form" method="POST" action="{{ route('admin.internal-memos.store', [], false) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="card-body">
