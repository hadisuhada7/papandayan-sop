...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    @else
        @switch(config('adminlte.laravel_asset_bundling', false))
            ...
            @default
                {{-- jQuery: load local first, fallback to CDN --}}
                <script src="{{ asset('vendor/jquery/jquery.min.js') }}"></script>
                <script>window.jQuery || document.write('<script src="https://code.jquery.com/jquery-3.7.1.min.js"><\/script>')</script>

                {{-- Bootstrap: load local first, fallback to CDN --}}
                <script src="{{ asset('vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
                <script>if(typeof jQuery !== 'undefined' && typeof jQuery.fn.modal === 'undefined'){document.write('<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"><\/script>')}</script>
