    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form id="policy-letter-form" method="POST" action="{{ route('admin.policy-letters.update', $policyLetter) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
...
@section('adminlte_js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#policy-letter-form').on('submit', function (e) {
                e.preventDefault();
