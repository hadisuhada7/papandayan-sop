...
@section('title', 'Papandayan | Edit User Profile')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary card-outline">
                ...
                <form method="POST" action="{{ route('admin.user-details.update', $userDetail) }}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name', optional($userDetail->user)->name) }}" maxlength="75" placeholder="Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="custom-control custom-radio" style="padding-top: 0.5rem;">
                                            <input class="custom-control-input" type="radio" id="categoryUserAdmin" name="category_user" value="admin" {{ old('category_user', $userDetail->category_user) == 'admin' ? 'checked' : '' }} required>
                                    ...
                                    <div class="col-sm-1">
                                        <div class="custom-control custom-radio" style="padding-top: 0.5rem;">
                                            <input class="custom-control-input" type="radio" id="categoryUserViewer" name="category_user" value="viewer" {{ old('category_user', $userDetail->category_user) == 'viewer' ? 'checked' : '' }} required>
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control select2bs4" style="width: 100%;" id="company" name="company_id" required>
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}" {{ $company->id == $userDetail->company_id ? 'selected' : '' }}>{{ $company->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row" id="access-row">
                                    ...
                                    <div class="col-sm-4">
                                        @php
                                            $selectedCategoryIds = (array) old('category_ids', $userDetail->categories->pluck('id')->toArray());
                                        @endphp
                                        <select class="form-control select2-tags" style="width: 100%;" id="access" name="category_ids[]" multiple="multiple" data-placeholder="" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" class="form-control" id="email" name="email" value="{{ $userDetail->email }}" maxlength="50" placeholder="Email" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="password" class="form-control" id="password" name="password" minlength="6" maxlength="25" placeholder="Password">
...
@section('adminlte_js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            const initialCategories = {!! json_encode($selectedCategories) !!};
            const initialCompanyId = '{{ $userDetail->company_id }}';
